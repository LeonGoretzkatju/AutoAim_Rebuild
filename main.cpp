...
void capture_init(VideoCapture &capture)
{
    ...
    VideoCapture rmcap("/home/alexliu/lxc/TJURobomaster/SJTU-RM-CV-2019-TJU-TEST-VERSION/kcf/2021-01-23 13:09:30.avi");
    VideoWriter rmvw;
#endif
    ...
    while(threadContinueFlag)
    {
        try{
            ...
            //{
                ...
                frameData.variable.shoot_mill = ElectronicControlParams::shoot_mill;
...
void ImageProcessThread()
{
    ...
    ArmorFinder armorfinder(camview_ptr,dnn_manager_ptr);
    armor_finder_ptr=&armorfinder;
    ...
    SentinelArmorHiter sentinelHiter(serial_ptr,armor_finder_ptr);
    armor_hiter_ptr = &sentinelHiter;
#elif defined ROBOT_INFANCY
    InfancyArmorHiter infancyHiter(serial_ptr,armor_finder_ptr);
    ...
    HeroArmorHiter heroHiter(serial_ptr,armor_finder_ptr);
    armor_hiter_ptr = &heroHiter;

    ShootHome shoothome(armor_finder_ptr,serial_ptr);
    shoot_home_ptr=&shoothome;
...
void ArmorDetectDebug(ImageData &frame)
{
    res = armor_finder_ptr->update_frame(frame,dtTime)*0.3;
}
